...
export default function Home() {
  ...
  return <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center">
              {user ? <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="sm" className="text-white hover:bg-white/10 hover:text-white w-10 h-10 rounded-full p-0">
                ...
                </DropdownMenu> : <Button variant="secondary" size="sm" onClick={() => setShowAuthSheet(true)} className="bg-white text-primary hover:bg-white/90">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-hero text-white pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button size="lg" variant="secondary" onClick={() => navigate('/customer')} className="text-lg px-8 py-6 bg-white text-primary hover:bg-white/90">
                  Try the Customer App
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
                <Button size="lg" variant="outline" onClick={() => navigate('/salon-register')} className="text-lg px-8 py-6 text-white hover:text-primary bg-primary border-primary">
                  List Your Salon
                </Button>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                {customerFeatures.map((feature, index) => <Card key={index} className="card-hover">
            ...
            <div>
              ...
              <div className="space-y-6">
                {salonFeatures.map((feature, index) => <Card key={index} className="card-hover">
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={() => navigate('/customer')} className="text-lg px-8 py-6">
              Try Customer App
              <ChevronRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" onClick={() => navigate('/salon-register')} className="text-lg px-8 py-6">
              List Your Salon
            </Button>
          </div>
        </div>
